""" This file will extract fault injection result with the fault occur during degree-353
...
def fault_injection(Injection_time, duration, vol):
    ...
    glitcher.arm(edge=Spider.RISING_EDGE, triggerCount=3) # Arm the glitcher to detect trigger 
...
if __name__ == '__main__':
    ...
    filename = 'CSIDH_plot_code\\fine_grain\\faulty rate\\353_04121012_d.csv'
